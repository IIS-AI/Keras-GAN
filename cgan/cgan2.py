...
def build_and_train_models_on_dataset(x_train, y_train):
    # # load MNIST dataset
...
if __name__ == '__main__':
    ...
    if args.generator:
        ...
        images, labels = generateLabeledDataset(100, (28,28), (3,3))
        build_and_train_models()
        # build_and_train_models_on_dataset(images, labels)